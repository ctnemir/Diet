            ...
            <div class="w-full overflow-x-hidden">
                <table class="w-full">
                    ...
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                        <th class="px-4 py-3">Diyet Metodu Adı</th>
                        <th class="px-4 py-3">Diyetisyen</th>
                        <th class="px-4 py-3">Oluşturma Tarihi</th>
                    ...
                    @foreach(\App\Models\DietMethod::all() as $method)
                        ...
                        <td class="px-4 py-3">
                            <a href="/dietMethod/{{$method->id}}/edit">
                        ...
                        <td class="px-4 py-3">
                            <div class=" break-words text-sm ">
                                {{$method->dietitian->name}}
                            </div>
                        </td>
                        <td class="px-4 py-3">
                            <div class=" break-words text-sm ">
                                @php
                                    $datetime = \Carbon\Carbon::parse($method->created_at);
                                    setlocale(LC_TIME, 'Turkish');  // ya da tr_TR.utf8
                                    echo $datetime ->formatLocalized('%A %d %B %Y');
                                @endphp
                            </div>
                        </td>
                        <td class="px-4 py-4 text-xs text-center text-purple-700 flex">
                            <div class="mr-6">
                                <a href="/dietMethod/{{$method->id}}/edit" class="inline-block">
                            ...
                            <div>
                                <form action="/dietMethod/{{$method->id}}" method="POST" class="inline-block">
                                    @csrf @method('DELETE')
                                    <button type="submit">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
